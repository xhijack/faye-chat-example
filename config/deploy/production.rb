...
server " 104.131.181.53", :web, :app, :db, primary: true

# set RAILS_ENV
set :rails_env, :production

# the name of your application
set :application_name, "pushchat"

# the domain you'll be deploying your application to
set :application_domain, "chat.sopwer.net"
...
# retrieved from from
set :scm, "git"
set :repository, "https://github.com/xhijack/faye-chat-example"
set :branch, "master"
